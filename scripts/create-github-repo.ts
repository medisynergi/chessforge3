// GitHub integration script to create repository and push code
...
async function main() {
  try {
    ...
    // Create repository
    console.log('Creating repository chessforge3...');
    ...
    if (error.status === 422) {
      console.error('Repository "chessforge3" already exists on your GitHub account.');
    } else {
